...
* Functional patterns for the object oriented - Øysteins presentation
...
* Etik-keynoten (onsdag morgon)
* Moons keynote - Earthbeat
* API for the decade
* Rusts felhantering
* Getting them to get it
* Judy Reese
* Clean language
* Turn up the Good - Woody Zuills presentation
* "Techno paganism"
* Nyheter i C# 8
